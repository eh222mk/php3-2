...
class LoginView implements \login\model\LoginObserver {
	...
	public function getRegisterBox(){
		...
		<form action='?RegisterAttempt' method='post'>
			<fieldset>
			<p>Användarnamn 3-9 tecken<input type='text' name='registerUsername' value='$username' /></p>
			<p>Lösenord 6-16 tecken<input type='password' name='registerPassword' /></p>
			<p>Repetera Lösenord<input type='password' name='repeatRegisterPassword' /></p>
			<p><input type='submit' value='Registrera' name='registerUser' /></p>
			</fieldset>
		</form>
		<a href=''>Tillbaka</a>";
